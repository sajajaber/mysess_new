...
$topbarActions = '
  <a href="' . ROOT . '/therapist/student/' . (int)$schedule->student_id . '"><button class="btn btn-primary">Back to Student</button></a>
';
    ...
    <?php foreach ($tasks as $task): ?>
      <div class="card" style="margin-bottom:16px;">
        <div class="card-body">
          ...
          <!-- Rate this task -->
          <form method="POST" action="<?= ROOT ?>/therapist/rate-independence" style="margin-top:12px;">
...
<div class="card">
  ...
  <div class="card-body">
    <form method="POST" action="<?= ROOT ?>/therapist/add-task">

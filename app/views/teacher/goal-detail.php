...
$topbarActions = '
  <a href="' . ROOT . '/teacher/student/' . (int)$goal->student_id . '"><button class="btn btn-primary">Back to Student</button></a>
';
...
<div class="card">
  ...
  <div class="card-body">
        ...
        <tbody>
          <?php foreach ($milestones as $m): ?>
            <tr>
              ...
              <td>
                <form method="POST" action="<?= ROOT ?>/teacher/toggle-milestone" class="inline-form">
    ...
    <!-- Add a milestone -->
    <form method="POST" action="<?= ROOT ?>/teacher/add-milestone" style="margin-top:16px;">
...
<div class="card">
  ...
  <div class="card-body">
    ...
    <form method="POST" action="<?= ROOT ?>/teacher/record-progress" style="margin-top:16px;">
      <input type="hidden" name="goal_id" value="<?= (int)$goal->id ?>">
      <div class="form-group">
